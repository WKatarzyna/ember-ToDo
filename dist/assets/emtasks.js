...
;define("emtasks/adapters/application", ["exports", "emberfire/adapters/firestore"], function (_exports, _firestore) {
  "use strict";
...
;define("emtasks/app", ["exports", "ember-resolver", "ember-load-initializers", "emtasks/config/environment"], function (_exports, _emberResolver, _emberLoadInitializers, _environment) {
  "use strict";
...
;define("emtasks/components/bs-dropdown/menu/link-to", ["exports", "ember-bootstrap/components/bs-dropdown/menu/link-to"], function (_exports, _linkTo) {
  "use strict";
...
;define("emtasks/components/bs-nav/link-to", ["exports", "ember-bootstrap/components/bs-nav/link-to"], function (_exports, _linkTo) {
  "use strict";
...
;define("emtasks/controllers/tasks", ["exports"], function (_exports) {
  "use strict";
...
;define("emtasks/controllers/tasks/edit", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.Controller.extend({
    ...
    actions: {
      editTask: function (id) {
        ...
        let date = this.get('model.date'); //Update Task
...
;define("emtasks/controllers/tasks/new", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.Controller.extend({
    ...
    actions: {
      addTask: function () {
        ...
        let date = this.get('date'); // alert(title)
        // alert(description)
        // alert(date)
        //Create New Task
...
;define("emtasks/helpers/app-version", ["exports", "emtasks/config/environment", "ember-cli-app-version/utils/regexp"], function (_exports, _environment, _regexp) {
  "use strict";
...
;define("emtasks/helpers/is-after", ["exports", "ember-moment/helpers/is-after"], function (_exports, _isAfter) {
  "use strict";
...
;define("emtasks/helpers/is-before", ["exports", "ember-moment/helpers/is-before"], function (_exports, _isBefore) {
  "use strict";
...
;define("emtasks/helpers/is-between", ["exports", "ember-moment/helpers/is-between"], function (_exports, _isBetween) {
  "use strict";
...
;define("emtasks/helpers/is-same-or-after", ["exports", "ember-moment/helpers/is-same-or-after"], function (_exports, _isSameOrAfter) {
  "use strict";
...
;define("emtasks/helpers/is-same-or-before", ["exports", "ember-moment/helpers/is-same-or-before"], function (_exports, _isSameOrBefore) {
  "use strict";
...
;define("emtasks/helpers/is-same", ["exports", "ember-moment/helpers/is-same"], function (_exports, _isSame) {
  "use strict";
...
;define("emtasks/helpers/moment-add", ["exports", "ember-moment/helpers/moment-add"], function (_exports, _momentAdd) {
  "use strict";
...
;define("emtasks/helpers/moment-calendar", ["exports", "ember-moment/helpers/moment-calendar"], function (_exports, _momentCalendar) {
  "use strict";
...
;define("emtasks/helpers/moment-diff", ["exports", "ember-moment/helpers/moment-diff"], function (_exports, _momentDiff) {
  "use strict";
...
;define("emtasks/helpers/moment-duration", ["exports", "ember-moment/helpers/moment-duration"], function (_exports, _momentDuration) {
  "use strict";
...
;define("emtasks/helpers/moment-format", ["exports", "ember-moment/helpers/moment-format"], function (_exports, _momentFormat) {
  "use strict";
...
;define("emtasks/helpers/moment-from-now", ["exports", "ember-moment/helpers/moment-from-now"], function (_exports, _momentFromNow) {
  "use strict";
...
;define("emtasks/helpers/moment-from", ["exports", "ember-moment/helpers/moment-from"], function (_exports, _momentFrom) {
  "use strict";
...
;define("emtasks/helpers/moment-subtract", ["exports", "ember-moment/helpers/moment-subtract"], function (_exports, _momentSubtract) {
  "use strict";
...
;define("emtasks/helpers/moment-to-date", ["exports", "ember-moment/helpers/moment-to-date"], function (_exports, _momentToDate) {
  "use strict";
...
;define("emtasks/helpers/moment-to-now", ["exports", "ember-moment/helpers/moment-to-now"], function (_exports, _momentToNow) {
  "use strict";
...
;define("emtasks/helpers/moment-to", ["exports", "ember-moment/helpers/moment-to"], function (_exports, _momentTo) {
  "use strict";
...
;define("emtasks/helpers/moment-unix", ["exports", "ember-moment/helpers/unix"], function (_exports, _unix) {
  "use strict";
...
;define("emtasks/helpers/moment", ["exports", "ember-moment/helpers/moment"], function (_exports, _moment) {
  "use strict";
...
;define("emtasks/helpers/now", ["exports", "ember-moment/helpers/now"], function (_exports, _now) {
  "use strict";
...
;define("emtasks/helpers/unix", ["exports", "ember-moment/helpers/unix"], function (_exports, _unix) {
  "use strict";
...
;define("emtasks/helpers/utc", ["exports", "ember-moment/helpers/utc"], function (_exports, _utc) {
  "use strict";
...
;define("emtasks/initializers/ember-concurrency", ["exports", "ember-concurrency/initializers/ember-concurrency"], function (_exports, _emberConcurrency) {
  "use strict";
...
;define("emtasks/initializers/export-application-global", ["exports", "emtasks/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("emtasks/initializers/load-bootstrap-config", ["exports", "emtasks/config/environment", "ember-bootstrap/config"], function (_exports, _environment, _config) {
  "use strict";
...
;define("emtasks/instance-initializers/ember-data", ["exports", "ember-data/initialize-store-service"], function (_exports, _initializeStoreService) {
  "use strict";
...
;define("emtasks/models/task", ["exports", "ember-data"], function (_exports, _emberData) {
  "use strict";
  ...
  const {
    attr
  } = _emberData.default; //Tworzenie schematu danych przy uzyciu biblioteki ember-data library
...
;define("emtasks/modifiers/ref", ["exports", "ember-ref-modifier/modifiers/ref"], function (_exports, _ref) {
  "use strict";
...
;define("emtasks/router", ["exports", "emtasks/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("emtasks/routes/tasks", ["exports", "emberfire/mixins/realtime-route", "emberfire/mixins/performance-route"], function (_exports, _realtimeRoute, _performanceRoute) {
  "use strict";
...
;define("emtasks/routes/tasks/edit", ["exports"], function (_exports) {
  "use strict";
  ...
  class TasksEditRoute extends Ember.Route {}

  _exports.default = TasksEditRoute;
});
;define("emtasks/routes/tasks/new", ["exports"], function (_exports) {
  "use strict";
  ...
  class TasksNewRoute extends Ember.Route {}
...
;define("emtasks/serializers/application", ["exports", "ember-data"], function (_exports, _emberData) {
  "use strict";
...
;define("emtasks/services/moment", ["exports", "ember-moment/services/moment", "emtasks/config/environment"], function (_exports, _moment, _environment) {
  "use strict";
...
;define("emtasks/templates/application", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "NsWwFtzz",
    "block": "{\"symbols\":[],\"statements\":[[9,\"nav\",true],[12,\"class\",\"navbar navbar-expand-lg navbar-dark bg-dark\",null],[10],[1,1,0,0,\"\\n    \"],[9,\"a\",true],[12,\"class\",\"navbar-brand\",null],[12,\"href\",\"#\",null],[10],[1,1,0,0,\"Navbar\"],[11],[1,1,0,0,\"\\n    \"],[9,\"button\",true],[12,\"class\",\"navbar-toggler\",null],[12,\"data-toggle\",\"collapse\",null],[12,\"data-target\",\"#navbarColor02\",null],[12,\"aria-controls\",\"navbarColor02\",null],[12,\"aria-expanded\",\"false\",null],[12,\"aria-label\",\"Toggle navigation\",null],[12,\"type\",\"button\",null],[10],[1,1,0,0,\"\\n        \"],[9,\"span\",true],[12,\"class\",\"navbar-toggler-icon\",null],[10],[11],[1,1,0,0,\"\\n    \"],[11],[1,1,0,0,\"\\n    \"],[9,\"div\",true],[12,\"class\",\"collapse navbar-collapse\",null],[12,\"id\",\"navbarColor02\",null],[10],[1,1,0,0,\"\\n        \"],[9,\"ul\",true],[12,\"class\",\"navbar-nav mr-auto\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"li\",true],[12,\"class\",\"nav-item active nav-link\",null],[10],[5,[27,[26,0,\"BlockHead\"],[]],null,[[\"route\"],[\"tasks\"]],[[\"default\"],[{\"statements\":[[1,1,0,0,\"Home\"]],\"parameters\":[]}]]],[11],[1,1,0,0,\"\\n            \"],[9,\"li\",true],[12,\"class\",\"nav-item active nav-link\",null],[10],[5,[27,[26,0,\"BlockHead\"],[]],null,[[\"route\"],[\"tasks.new\"]],[[\"default\"],[{\"statements\":[[1,1,0,0,\"New Task\"]],\"parameters\":[]}]]],[11],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n    \"],[11],[1,1,0,0,\"\\n\"],[11],[1,1,0,0,\"\\n\"],[9,\"div\",true],[12,\"class\",\"container\",null],[10],[1,1,0,0,\"\\n    \"],[9,\"div\",true],[12,\"class\",\"row\",null],[10],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"col-md-12\",null],[10],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,0,0,[27,[26,2,\"CallHead\"],[]],[[31,0,0,[27,[26,1,\"CallHead\"],[]],null,null]],null]],[1,1,0,0,\"\\n            \"],[2,\"outlet renderuje templaty w odpowiednim miejscu \"],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n    \"],[11],[1,1,0,0,\"\\n\"],[11],[1,1,0,0,\"\\n\"]],\"hasEval\":false,\"upvars\":[\"link-to\",\"-outlet\",\"component\"]}",
    "meta": {
...
;define("emtasks/templates/tasks", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "yrkG4zq1",
    "block": "{\"symbols\":[\"task\"],\"statements\":[[1,0,0,0,[31,0,0,[27,[26,4,\"CallHead\"],[]],[[31,0,0,[27,[26,3,\"CallHead\"],[]],null,null]],null]],[1,1,0,0,\"\\n\"],[2,\"osadzenie dokumentu\"],[1,1,0,0,\"\\n\"],[9,\"h1\",true],[10],[1,1,0,0,\"Tasks' list:\"],[11],[1,1,0,0,\"\\n\"],[5,[27,[26,7,\"BlockHead\"],[]],[[31,0,0,[27,[26,6,\"CallHead\"],[]],[[31,0,0,[27,[26,6,\"CallHead\"],[]],[[27,[26,5,\"Expression\"],[]]],null]],null]],null,[[\"default\"],[{\"statements\":[[1,1,0,0,\"    \"],[9,\"div\",true],[12,\"class\",\"alert alert-dismissible alert-success\",null],[10],[1,1,0,0,\"\\n        \"],[9,\"h4\",true],[10],[9,\"strong\",true],[10],[1,0,0,0,[27,[24,1],[\"title\"]]],[11],[11],[1,1,0,0,\"\\n        \"],[9,\"ul\",true],[10],[1,1,0,0,\"\\n            \"],[9,\"li\",true],[10],[1,0,0,0,[27,[24,1],[\"description\"]]],[11],[1,1,0,0,\"\\n            \"],[9,\"li\",true],[10],[1,0,0,0,[31,264,13,[27,[26,0,\"CallHead\"],[]],[[27,[24,1],[\"date\"]],\"DD/MM/YYYY\"],null]],[11],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"button\",false],[23,\"class\",\"btn btn-danger\",null],[3,0,0,[27,[26,1,\"ModifierHead\"],[]],[[27,[24,0],[]],\"deleteTask\",[27,[24,1],[\"id\"]]],null],[10],[1,1,0,0,\"Delete\"],[11],[1,1,0,0,\"\\n        \"],[9,\"button\",true],[12,\"class\",\"btn btn-secondary\",null],[10],[5,[27,[26,2,\"BlockHead\"],[]],null,[[\"route\",\"model\"],[\"tasks.edit\",[27,[24,1],[\"id\"]]]],[[\"default\"],[{\"statements\":[[1,1,0,0,\"Edit\"]],\"parameters\":[]}]]],[11],[1,1,0,0,\"\\n    \"],[11],[1,1,0,0,\"\\n    \"],[9,\"hr\",true],[10],[11],[1,1,0,0,\"\\n\"]],\"parameters\":[1]}]]]],\"hasEval\":false,\"upvars\":[\"moment-format\",\"action\",\"link-to\",\"-outlet\",\"component\",\"model\",\"-track-array\",\"each\"]}",
    "meta": {
...
;define("emtasks/templates/tasks/edit", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "VuvwWHdV",
    "block": "{\"symbols\":[],\"statements\":[[9,\"form\",true],[10],[1,1,0,0,\"\\n    \"],[9,\"fieldset\",true],[10],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"title\",null],[10],[1,1,0,0,\"Task Title\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,117,5,[27,[26,1,\"CallHead\"],[]],null,[[\"type\",\"class\",\"id\",\"value\",\"placeholder\"],[\"text\",\"form-control\",\"title\",[27,[26,0,\"Expression\"],[\"title\"]],\"Add Task.......\"]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"dateInput\",null],[10],[1,1,0,0,\"Due Date\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,347,5,[27,[26,1,\"CallHead\"],[]],null,[[\"type\",\"class\",\"id\",\"placeholder\",\"value\"],[\"date\",\"form-control\",\"dateInput\",\"Insert date...\",[27,[26,0,\"Expression\"],[\"date\"]]]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"description\",null],[10],[1,1,0,0,\"Description\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,567,8,[27,[26,2,\"CallHead\"],[]],null,[[\"class\",\"value\",\"placeholder\",\"id\",\"rows\"],[\"form-control\",[27,[26,0,\"Expression\"],[\"description\"]],\"Describe Task..\",\"description\",\"3\"]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"button\",false],[23,\"class\",\"btn btn-primary\",null],[3,0,0,[27,[26,3,\"ModifierHead\"],[]],[[27,[24,0],[]],\"editTask\",[27,[26,0,\"Expression\"],[\"id\"]]],null],[10],[1,1,0,0,\"Submit\"],[11],[1,1,0,0,\"\\n\\n    \"],[11],[1,1,0,0,\"\\n\"],[11]],\"hasEval\":false,\"upvars\":[\"model\",\"input\",\"textarea\",\"action\"]}",
    "meta": {
      "moduleName": "emtasks/templates/tasks/edit.hbs"
    }
  });

  _exports.default = _default;
});
;define("emtasks/templates/tasks/new", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "rVUuxAax",
    "block": "{\"symbols\":[],\"statements\":[[9,\"div\",true],[12,\"class\",\"jumbotron\",null],[10],[1,1,0,0,\"\\n    \"],[9,\"h1\",true],[12,\"class\",\"display-3\",null],[10],[1,1,0,0,\"Welcome in Task Manager!\"],[11],[1,1,0,0,\"\\n    \"],[9,\"p\",true],[12,\"class\",\"lead\",null],[10],[1,1,0,0,\"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore\\n        et dolore magna aliqua.\"],[11],[1,1,0,0,\"\\n    \"],[9,\"hr\",true],[12,\"class\",\"my-4\",null],[10],[11],[1,1,0,0,\"\\n\"],[11],[1,1,0,0,\"\\n\"],[9,\"form\",true],[10],[1,1,0,0,\"\\n    \"],[9,\"fieldset\",true],[10],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"title\",null],[10],[1,1,0,0,\"Task Title\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,382,5,[27,[26,1,\"CallHead\"],[]],null,[[\"type\",\"class\",\"id\",\"value\",\"placeholder\"],[\"text\",\"form-control\",\"title\",[27,[26,0,\"Expression\"],[]],\"Add Task.......\"]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"dateInput\",null],[10],[1,1,0,0,\"Due Date\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,606,5,[27,[26,1,\"CallHead\"],[]],null,[[\"type\",\"class\",\"id\",\"placeholder\",\"value\"],[\"date\",\"form-control\",\"dateInput\",\"Insert date...\",[27,[26,2,\"Expression\"],[]]]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"div\",true],[12,\"class\",\"form-group\",null],[10],[1,1,0,0,\"\\n            \"],[9,\"label\",true],[12,\"for\",\"description\",null],[10],[1,1,0,0,\"Description\"],[11],[1,1,0,0,\"\\n          \"],[1,0,0,0,[31,819,8,[27,[26,4,\"CallHead\"],[]],null,[[\"class\",\"value\",\"placeholder\",\"id\",\"rows\"],[\"form-control\",[27,[26,3,\"Expression\"],[]],\"Describe Task..\",\"description\",\"3\"]]]],[1,1,0,0,\"\\n        \"],[11],[1,1,0,0,\"\\n        \"],[9,\"button\",false],[23,\"class\",\"btn btn-primary\",null],[3,0,0,[27,[26,5,\"ModifierHead\"],[]],[[27,[24,0],[]],\"addTask\"],null],[10],[1,1,0,0,\"Submit\"],[11],[1,1,0,0,\"\\n\\n    \"],[11],[1,1,0,0,\"\\n\"],[11]],\"hasEval\":false,\"upvars\":[\"title\",\"input\",\"date\",\"description\",\"textarea\",\"action\"]}",
    "meta": {
